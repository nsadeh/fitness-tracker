...
var $author$project$Main$showSet = function (set) {
	return $elm$core$String$fromFloat(set.weight) + ('lbs ' + ($elm$core$String$fromInt(set.reps) + 'reps!'));
};
var $author$project$Main$showAllSets = function (sets) {
	var texts = A2(
		$elm$core$Maybe$map,
		$author$project$Main$showSet,
		$elm$core$List$head(sets));
	if (texts.$ === 'Just') {
		var text = texts.a;
		return text;
	} else {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$text(' '),
				$elm$html$Html$text(
				$author$project$Main$showAllSets(model.sets))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Main$init, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Basics.Bool","aliases":{},"unions":{"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}}}}})}});
